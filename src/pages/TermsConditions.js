    ...
    <div className="terms-conditions">
      ...
      <main className="terms-content">
        <div className="lilylamb-kids-we">
          Welcome to LinklyGifts! These Terms and Conditions ("Terms") govern
        ...
        <div className="information-we-collect-parent">
          ...
          <div className="frame-parent">
            <div className="about-linklygifts-parent">
              <h3 className="about-linklygifts">1.1 About LinklyGifts</h3>
              <div className="linklygifts-is-a">
                LinklyGifts is a provider of electronic SIM cards (eSIMs) that
            ...
            <div className="changes-to-terms-parent">
        ...
        <FrameComponent1
          ...
          toUseOurServicesYouMustBe="To use our services, you must be at least 18 years old and have the legal capacity to enter into a binding contract. By registering an account with LinklyGifts, you represent and warrant that you meet these requirements."
        ...
        <FrameComponent
          ...
          allIntellectualPropertyRi="All intellectual property rights in our website and services, including but not limited to text, graphics, logos, and software, are owned by or licensed to LinklyGifts. You do not acquire any ownership rights by using our services."
          license="6.2 License"
            ...
            <div className="limitation-of-liability-parent">
              ...
              <div className="to-the-fullest-container">
                <p className="to-the-fullest">
                  To the fullest extent permitted by law, LinklyGifts will not
          ...
          <div className="indemnification-content">
            <div className="you-agree-to-indemnify-defend-wrapper">
              <div className="you-agree-to1">
                You agree to indemnify, defend, and hold harmless LinklyGifts,
        ...
        <FrameComponent
          ...
          allIntellectualPropertyRi="These Terms and your use of our services will be governed by and construed in accordance with the laws of the jurisdiction in which LinklyGifts is headquartered, without regard to its conflict of law principles."
          license="10.2 Dispute Resolution"
          weGrantYouALimitedNonExcl="Any disputes arising out of or relating to these Terms or our services will be resolved through binding arbitration, rather than in court, except that you may assert claims in small claims court if your claims qualify. The arbitration will be conducted in the jurisdiction where LinklyGifts is headquartered and will be governed by the rules of the American Arbitration Association."
        />
          ...
          <div className="frame-div">
            <div className="entire-agreement-parent">
              ...
              <div className="these-terms-constitute">
                ...
                LinklyGifts regarding the use of our services and supersede any
            ...
            <div className="waiver-parent">
              ...
              <div className="no-waiver-of">
                ...
                LinklyGifts's failure to assert any right or provision under
        ...
        <div className="contact-information-parent">
          ...
          <div className="contact-content">
            <div className="if-you-have-container">
              ...
              <p className="linklygifts-customer-support">{`LinklyGifts, Customer Support `}</p>
              <p className="email-supportlinklygiftscom">{`Email: support@LinklyGifts.com `}</p>
              ...
              <p className="by-using-linklygiftss">
                By using LinklyGifts's services, you acknowledge that you have
